...
import { getLectureLabel } from "@/lib/lectures";
...
export function GlossaryApp() {
  ...
  const filteredTerms = useMemo(() => {
    ...
    const result = terms.filter((item) => !normalized || item.term.toLocaleLowerCase("he").includes(normalized) || item.definition.toLocaleLowerCase("he").includes(normalized) || getLectureLabel(item.lecture_id).toLocaleLowerCase("he").includes(normalized));
